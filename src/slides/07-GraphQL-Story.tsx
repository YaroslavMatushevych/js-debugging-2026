export function GraphQLStorySlide() {
  return (
    <div className="slide">
          ...
          <div className="flex-col gap-16">
            ...
            <div style={{ padding: '10px 14px', background: 'var(--card)', borderRadius: 6, borderLeft: '3px solid var(--border2)' }}>
              <p style={{ fontSize: '0.85rem' }}>
                <strong>Invest in observability.</strong> Without OpenTelemetry and X-Ray this query would have kept running silently for months. The tooling found it in seconds.
              </p>
            </div>
          </div>
